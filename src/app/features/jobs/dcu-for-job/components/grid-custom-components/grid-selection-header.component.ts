...
export class DcuForJobGridSelectionHeaderComponent implements IHeaderAngularComp, OnDestroy {
  public params: any;
  ...
  constructor(public fb: FormBuilder, private service: DcuForJobGridEventEmitterService) {
