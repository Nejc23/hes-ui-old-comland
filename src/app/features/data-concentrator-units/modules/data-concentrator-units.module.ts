...
import { DataConcentratorUnitsComponent, StringifyEmployeesPipe } from '../components/data-concentrator-units.component';
...
@NgModule({
  entryComponents: [],
  declarations: [DataConcentratorUnitsComponent, ActionFormComponent, StringifyEmployeesPipe],
