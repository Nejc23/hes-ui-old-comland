  ...
  public setGridDefaultColumns(sample: boolean) {
    return [
      ...
      },
      {
        ...
        headerName: `Parametrisation Id`,
        pinned: false,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellIdNumberComponent',
        headerTooltip: `Parametrisation Id`,
        suppressMenu: true,
        suppressMovable: true,
        resizable: false
      },
      {
        ...
        headerName: `Time of use Id`,
        pinned: false,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellTimeOfUseIdComponent',
        headerTooltip: `Time of use Id`,
        suppressMenu: true,
        suppressMovable: true,
        resizable: false
      },
      ...
      },
      {
        ...
        headerName: `Configuration Id`,
        pinned: false,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellIdNumberComponent',
        headerTooltip: `Configuration Id`,
        hide: true,
        suppressMenu: true,
        suppressMovable: true,
        resizable: false
      ...
      // },
      {
        ...
        headerName: `Disconnector State`,
        pinned: false,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellBreakerStateComponent',
        headerTooltip: `Disconnector State`,
        suppressMenu: true,
        suppressMovable: true,
        resizable: false
      },
      ...
      },
      {
        ...
        headerName: `CII State`,
        pinned: false,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellCiiStateComponent',
        headerTooltip: `CII State`,
        suppressMenu: true,
        suppressMovable: true,
        resizable: false
      },
      ...
      },
      {
        ...
        headerName: `Limiter 1 Th. normal`,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellThresholdComponent',
        headerTooltip: `Limiter 1 Th. normal`,
        resizable: false,
        suppressMenu: true,
        suppressMovable: true
      },
      {
        ...
        headerName: `Limiter 1 Th. emergency`,
        pinned: false,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellThresholdComponent',
        headerTooltip: `Limiter 1 Th. emergency`,
        suppressMenu: true,
        suppressMovable: true,
        resizable: false
      },
      {
        ...
        headerName: `Limiter 2 Th. normal`,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellThresholdComponent',
        headerTooltip: `Limiter 2 Th. emergency`,
        resizable: false,
        suppressMenu: true,
        suppressMovable: true
      },
      {
        ...
        headerName: `Limiter 2 Th. emergency`,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellThresholdComponent',
        headerTooltip: `Limiter 2 Th. emergency`,
      ...
      },
      {
        ...
        headerName: `Current L1 Monitor`,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellThresholdComponent',
        headerTooltip: `Current L1 Monitor`,
        resizable: false,
        suppressMenu: true,
        suppressMovable: true
      },
      {
        ...
        headerName: `Current L2 Monitor`,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellThresholdComponent',
        headerTooltip: `Current L2 Monitor`,
        resizable: false,
        suppressMenu: true,
        suppressMovable: true
      },
      {
        ...
        headerName: `Current L3 Monitor`,
        sortable: true,
        filter: false,
        cellRenderer: 'gridCellThresholdComponent',
        headerTooltip: `Current L3 Monitor`,
        resizable: false,
        suppressMenu: true,
        suppressMovable: true
      }
