...
@Component({
  selector: 'app-grid-cell-firmware',
  templateUrl: './grid-cell-firmware.component.html'
})
export class GridCellFirmwareComponent implements ICellRendererAngularComp {
