...
@Component({
  selector: 'app-grid-cell-alarm-protocol',
  templateUrl: './grid-cell-alarm-protocol.component.html'
})
export class GridCellAlarmProtocolComponent implements ICellRendererAngularComp {
  public params: any;
