...
import { MeterUnitsActivateUpgradeResponse } from 'src/app/core/repository/interfaces/meter-units/meter-units-acctivate-upgrade.interface';
...
export class MeterUnitsActivateUpgradeInterceptor {
  ...
  static interceptActivateDeviceUpgradePost(request: HttpRequest<any>): Observable<HttpEvent<any>> {
    const data: MeterUnitsActivateUpgradeResponse = {
