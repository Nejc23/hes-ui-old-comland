...
describe('Pact consumer test', () => {
  ...
  describe('DCU operation for device discovery with ids in request', () => {
    beforeAll((done) => {
      provider
        .addInteraction({
          state: 'A_REQUEST_DCU_OPERATION_FOR_DEVICE_DISCOVERY_WITH_IDS_IN_REQUEST',
          uponReceiving: 'a request for trigger dcu operation for device dicovery with ids in request',
          withRequest: {
    ...
    it('should make request for trigger dcu operation for device discovery with ids in request', (done) => {
