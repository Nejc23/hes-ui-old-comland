...
describe('Pact consumer test', () => {
  ...
  describe('myGrid.link trigger CII activate device with device ids', () => {
    beforeAll(done => {
      provider
        .addInteraction({
          state: 'A_REQUEST_MY_GRID_LINK_FOR_TRIGGER_CII_ACTIVATE_DEVICE_WITH_IDS',
          uponReceiving: 'a request for trigger CII activate device with ids in request - myGrid.Link',
          withRequest: {
    ...
    it('should make request for trigger CII activate device with ids in request - myGrid.Link', done => {
