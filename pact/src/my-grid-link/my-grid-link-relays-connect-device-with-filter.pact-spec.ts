...
describe('Pact consumer test', () => {
  ...
  describe('myGrid.link trigger connect device with filter request', () => {
    beforeAll((done) => {
      provider
        .addInteraction({
          state: 'A_REQUEST_MY_GRID_LINK_FOR_TRIGGER_RELAYS_CONNECT_DEVICE_WITH_FILTER',
    ...
    it('should make request for trigger relays connect device with filter in request - myGrid.Link', (done) => {
